      ...
      <div className="min-h-screen bg-[#F8F9FF]">
        <div className="mx-auto max-w-7xl p-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-[#1a1d24]">Vision Care</h1>
          ...
          <Card className="p-6">
            {diagnosisState === "idle" && (
              <div className="text-center">
                <Eye className="mx-auto h-24 w-24 text-[#4B82EA] mb-4" />
                <h2 className="text-2xl font-semibold mb-4">AI-Powered Vision Diagnosis</h2>
                <p className="mb-4">Click the button below to start your AI-powered vision diagnosis.</p>
            ...
            {diagnosisState === "camera" && (
              <div className="text-center">
                <h2 className="text-2xl font-semibold mb-4">Capture Eye Image</h2>
                <p className="mb-4">Please take a clear photo of your eye for analysis.</p>
            ...
            {diagnosisState === "in-progress" && (
              <div className="text-center">
                <div className="relative mx-auto h-48 w-48 mb-4">
                  ...
                  <Eye className="absolute inset-0 h-full w-full text-[#4B82EA] animate-pulse" />
                </div>
                <h2 className="text-2xl font-semibold mb-4">Diagnosis in progress...</h2>
                <p>Our AI is analyzing your vision. This may take a few moments.</p>
              </div>
            )}

            {diagnosisState === "complete" && (
              <div className="text-center">
                <Eye className="mx-auto h-24 w-24 text-[#4CAF50] mb-4" />
                <h2 className="text-2xl font-semibold mb-4">Diagnosis Complete</h2>
                <p className="mb-4">Here's your vision diagnosis report, you can still view this in Health Overview:</p>
                <DiagnosisReport type="vision" date={new Date().toISOString().split("T")[0]} />
              </div>
            )}
          </Card>
        </div>
